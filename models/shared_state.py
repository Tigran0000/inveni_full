...
# Updated import to reflect new project structure
...
class SharedState:
    ...
    def __init__(self):
        ...
        self.current_user: str = os.getlogin()  # Get actual system username
        self._active = True
    ...
    def notify_version_change(self) -> None:
        ...
        Updates the last_update timestamp with UTC time.
        """
